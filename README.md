...
- [idea](idea/)
  - [idea1_BMA](idea/idea1_BMA/)
    ...
    - [version_1.0_quan_ly_nguyen_lieu_san_xuat](idea/idea1_BMA/version_1.0_quan_ly_nguyen_lieu_san_xuat/)
      ...
      - [module_4_trang_chu](idea/idea1_BMA/version_1.0_quan_ly_nguyen_lieu_san_xuat/module_4_trang_chu/)
        - [README.md](idea/idea1_BMA/version_1.0_quan_ly_nguyen_lieu_san_xuat/module_4_trang_chu/README.md)
...
- [project-notes](project-notes/)
  - [personal](project-notes/personal/)
    ...
    - [brewing-manger](project-notes/personal/brewing-manger/)
      - [client](project-notes/personal/brewing-manger/client/)
      - [server](project-notes/personal/brewing-manger/server/)
        - [api](project-notes/personal/brewing-manger/server/api/)
          - [batch](project-notes/personal/brewing-manger/server/api/batch/)
            - [delete_api_batch_id.md](project-notes/personal/brewing-manger/server/api/batch/delete_api_batch_id.md)
            - [get_api_batch_id.md](project-notes/personal/brewing-manger/server/api/batch/get_api_batch_id.md)
            - [get_api_batches.md](project-notes/personal/brewing-manger/server/api/batch/get_api_batches.md)
            - [get_api_pagination_batches.md](project-notes/personal/brewing-manger/server/api/batch/get_api_pagination_batches.md)
            - [get_api_total_batches_by_time.md](project-notes/personal/brewing-manger/server/api/batch/get_api_total_batches_by_time.md)
            - [get_api_total_batches.md](project-notes/personal/brewing-manger/server/api/batch/get_api_total_batches.md)
            - [post_api_batch.md](project-notes/personal/brewing-manger/server/api/batch/post_api_batch.md)
            - [put_api_batch_id.md](project-notes/personal/brewing-manger/server/api/batch/put_api_batch_id.md)
          - [ingredient](project-notes/personal/brewing-manger/server/api/ingredient/)
            - [type](project-notes/personal/brewing-manger/server/api/ingredient/type/)
              - [delete_api_type_id.md](project-notes/personal/brewing-manger/server/api/ingredient/type/delete_api_type_id.md)
              - [get_api_types.md](project-notes/personal/brewing-manger/server/api/ingredient/type/get_api_types.md)
              - [post_api_type.md](project-notes/personal/brewing-manger/server/api/ingredient/type/post_api_type.md)
            - [delete_api_ingredient_id.md](project-notes/personal/brewing-manger/server/api/ingredient/delete_api_ingredient_id.md)
            - [get_api_ingredient_id.md](project-notes/personal/brewing-manger/server/api/ingredient/get_api_ingredient_id.md)
            - [get_api_ingredients.md](project-notes/personal/brewing-manger/server/api/ingredient/get_api_ingredients.md)
            - [get_api_pagination_ingredient.md](project-notes/personal/brewing-manger/server/api/ingredient/get_api_pagination_ingredient.md)
            - [get_api_total_ingredients.md](project-notes/personal/brewing-manger/server/api/ingredient/get_api_total_ingredients.md)
          ...
          - [recipe](project-notes/personal/brewing-manger/server/api/recipe/)
            ...
            - [get_api_recipe_id.md](project-notes/personal/brewing-manger/server/api/recipe/get_api_recipe_id.md)
            - [get_api_recipes.md](project-notes/personal/brewing-manger/server/api/recipe/get_api_recipes.md)
            - [get_api_top5_by_time.md](project-notes/personal/brewing-manger/server/api/recipe/get_api_top5_by_time.md)
            - [get_api_top5_most_used.md](project-notes/personal/brewing-manger/server/api/recipe/get_api_top5_most_used.md)
            - [get_api_total_recipes.md](project-notes/personal/brewing-manger/server/api/recipe/get_api_total_recipes.md)
            - [post_api_recipe.md](project-notes/personal/brewing-manger/server/api/recipe/post_api_recipe.md)
            - [put_api_recipe_id.md](project-notes/personal/brewing-manger/server/api/recipe/put_api_recipe_id.md)
      - [README.md](project-notes/personal/brewing-manger/README.md)
      - [summary.md](project-notes/personal/brewing-manger/summary.md)

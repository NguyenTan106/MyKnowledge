...
- [idea](idea/)
  - [idea1_MPM (Material & Production Manager)](idea/idea1_MPM (Material & Production Manager)/)
    - [description.md](idea/idea1_MPM (Material & Production Manager)/description.md)
    - [pre-project.md](idea/idea1_MPM (Material & Production Manager)/pre-project.md)
